...
/usr/bin/time --verbose constructFlat.py $REPODIR --rerun flat_test_80k --longlog --id visit=5000410..5000480 raftName=R22 detectorName=S11 --calib /global/cscratch1/sd/descdm/DC2/Run2.1i/calibration/calib_repo/CALIB --batch-type=smp --cores 20 |& tee constructFlat_test_80k.log
