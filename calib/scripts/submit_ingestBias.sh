...
/usr/bin/time --verbose ingestCalibs.py $REPODIR --output CALIB --validity 4000 $REPODIR/rerun/construct_calib/bias/2022-01-01/*.fits --longlog -j 63 --mode copy |& tee ingestBias.log
