...
/usr/bin/time --verbose ingestCalibs.py $REPODIR --output $ROOTDIR/CALIB --validity 4000 $REPODIR/rerun/construct_dark/flat/i/2022-08-06/*.fits --longlog -j 63 --mode copy |& tee ingestFlat.log
